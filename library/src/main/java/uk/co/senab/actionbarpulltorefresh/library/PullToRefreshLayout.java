...
/**
 * The main component of the library. You wrap the views you wish to be 'pullable' within this layout. This layout is setup by using the {@link ActionBarPullToRefresh} setup-wizard return by
 * 
...
public class PullToRefreshLayout extends FrameLayout {
	...
	/**
	 * Set a {@link uk.co.senab.actionbarpulltorefresh.library.listeners.HeaderViewListener} which is called when the visibility state of the Header View has changed.
	 *
	 * @param listener
	 */
	...
	public static class LayoutParams extends FrameLayout.LayoutParams {
		...
		public LayoutParams(int width, int height, String s) {
			this(width, height);
			mViewDelegateClassName = s;
		}

		public void setViewDelegateClassName(String s) {
			mViewDelegateClassName = s;
		}
